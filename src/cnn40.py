...
imageStringList = []
imageStringList.extend(df3.loc[:700,"Image"])
...
# output
Y1 = np.stack(df3.ix[:700,[0,1,2,3]].values,axis=0) 			# Y.shape(7000,4)
Y2 = augment.swap(Y1)
...
model.save('src/cnn40.h5')

# plot loss and metric curves
curves.generate(hist.history,'cnn40')