...
model.add(Conv2D(filters=32, kernel_size=(7,7), strides=(1,1), kernel_initializer='he_normal'))     # OUTPUT (90,90,32)
model.add(Activation("relu"))
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))                                             # OUTPUT (45,45,32)
model.add(Dropout(0.13))

model.add(Conv2D(filters=64, kernel_size=(6,6), strides=(1,1), kernel_initializer='he_normal'))     # OUTPUT (40,40,64)
model.add(Activation("relu"))
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))                                             # OUTPUT (20,20,64)
model.add(Dropout(0.13))

model.add(Conv2D(filters=128, kernel_size=(5,5), strides=(1,1), kernel_initializer='he_normal'))    # OUTPUT (16,16,128)
model.add(Activation("relu"))
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))                                             # OUTPUT (8,8,128)
model.add(Dropout(0.13))

model.add(Conv2D(filters=256, kernel_size=(3,3), strides=(1,1), kernel_initializer='he_normal'))    # OUTPUT (6,6,256)
model.add(Activation("relu"))
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))                                             # OUTPUT (3,3,256)
model.add(Dropout(0.13))

model.add(Conv2D(filters=512, kernel_size=(3,3), strides=(1,1), kernel_initializer='he_normal'))    # OUTPUT (1,1,512)
model.add(Activation("relu"))
model.add(Dropout(0.13))

model.add(Flatten())                                                                                # OUTPUT (512)
...
curves.generate(hist.history,'cnn21')
