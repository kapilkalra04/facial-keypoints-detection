...
model.add(Conv2D(filters=60, kernel_size=(3,3), strides=(1,1)))                                     # OUTPUT (6,6,24*36*48*60)
model.add(Activation("relu"))
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))                                             # OUTPUT (3,3,24*36*48*60)
model.add(Dropout(0.13))

model.add(Conv2D(filters=72, kernel_size=(3,3), strides=(1,1)))                                     # OUTPUT (1,1,24*36*48*60*72)
model.add(Activation("relu"))
...
curves.generate(hist.history,'cnn6')
